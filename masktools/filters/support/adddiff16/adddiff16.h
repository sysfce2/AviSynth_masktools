      ...
      /* add the processors */
        if (parameters["stacked"].toBool() == true) {
          ...
          case 10: 
            ...
            processors.push_back(Filtering::Processor<Processor>(adddiff16_native_10_sse4_1, Constraint(CPU_SSE4_1, MODULO_NONE, MODULO_NONE, ALIGNMENT_NONE, 1), 1));
            break;
          case 12:
            ...
            processors.push_back(Filtering::Processor<Processor>(adddiff16_native_12_sse4_1, Constraint(CPU_SSE4_1, MODULO_NONE, MODULO_NONE, ALIGNMENT_NONE, 1), 1));
            break;
          case 14:
            ...
            processors.push_back(Filtering::Processor<Processor>(adddiff16_native_14_sse4_1, Constraint(CPU_SSE4_1, MODULO_NONE, MODULO_NONE, ALIGNMENT_NONE, 1), 1));
            break;
          case 16:
            ...
            processors.push_back(Filtering::Processor<Processor>(adddiff16_native_16_sse4_1, Constraint(CPU_SSE4_1, MODULO_NONE, MODULO_NONE, ALIGNMENT_NONE, 1), 1));
            break;
          }
        }
    }

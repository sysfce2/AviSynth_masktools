...
protected:
   ...
   virtual void process(int n, const Plane<Byte> &dst, int nPlane, const ::Filtering::Frame<const Byte> frames[3], const Constraint constraints[3], PNeoEnv env) override
    {
        UNUSED(n); UNUSED(env);
...
public:
   MorphologicFilter16(const Parameters &parameters, PNeoEnv env)
